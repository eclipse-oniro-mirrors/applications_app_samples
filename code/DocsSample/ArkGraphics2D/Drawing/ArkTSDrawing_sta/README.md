...
3. 进入”DocsSample/Drawing/ArkTSDrawing_sta/entry/src/ohosTest/ets/test/DrawingAbility.test.ets“文件，可以对本项目进行UI的自动化测试。
...
echo code/DocsSample/Drawing/ArkTSDrawing_sta/ > .git/info/sparse-checkout
