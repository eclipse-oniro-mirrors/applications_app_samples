...
3. 进入“DocsSample/ArkGraphics2D/TextEngine/SimpleTextDrawing/entry/src/ohosTest/ets/test/DrawingAbility.test.ets”文件，可以对本项目进行UI的自动化测试。
...
echo code/DocsSample/ArkGraphics2D/TextEngine/SimpleTextDrawing/ > .git/info/sparse-checkout
