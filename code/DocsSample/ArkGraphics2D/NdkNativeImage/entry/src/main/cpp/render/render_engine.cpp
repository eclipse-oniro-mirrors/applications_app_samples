...
void RenderEngine::UpdateSurfaceImage()
{
    ...
    // [StartExclude update_surfaceimage]
    availableFrameCnt_--;
}
// [EndExclude update_surfaceimage]
...
{
    // [Start nativeimage_change_context]
    ...
    // [StartExclude nativeimage_change_context]
...
{
    // [EndExclude nativeimage_change_context]
    int ret = OH_NativeImage_AttachContext(nativeImage_, nativeImageTexId_);
    // [End nativeimage_change_context]
    if (ret != 0) {
        OH_LOG_Print(LOG_APP, LOG_ERROR, LOG_PRINT_DOMAIN, "RenderEngine",
...
void RenderEngine::DestroyNativeImage()
{
    ...
    if (nativeImage_ != nullptr) {
        ...
        // [Start destroy_nativeimage]
        OH_NativeImage_Destroy(&nativeImage_);
        // [End destroy_nativeimage]
