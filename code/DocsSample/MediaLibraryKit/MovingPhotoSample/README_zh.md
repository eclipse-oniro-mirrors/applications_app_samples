...
- [@kit.ArkData](https://gitcode.com/openharmony/docs/blob/master/zh-cn/application-dev/database/Readme-CN.md) - 提供数据管理能力
...
echo code/DocsSample/MediaLibraryKit/MovingPhotoSample/ > .git/info/sparse-checkout
