...
extern ArkUI_NativeDialogHandle dialogController;
extern ArkUI_NodeHandle buttonNode;
extern bool isShown;
...
extern int32_t id;
ArkUI_NodeHandle buttonNode = nullptr;
ArkUI_CustomDialogOptions* dialogOptions = nullptr;
constexpr int32_t BUTTON_CLICK_ID = 1;
bool isShown = false;
...
ArkUI_NativeDialogHandle dialogController = nullptr;
ArkUI_NodeHandle buttonNode = nullptr;
constexpr int32_t BUTTON_CLICK_ID = 1;
bool isShown = false;
