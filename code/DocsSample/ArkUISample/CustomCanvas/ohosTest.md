...
| 测试画布组件通过通用事件设置可见区域近似变化回调是否成功    | 设备正常运行 | 进入各个示例页面，push页面，点击draw sth按钮触发绘制，返回 | 画布绘制正常 | 是       | Pass     |
| 测试画布组件可见区域近似变化回调是否成功    | 设备正常运行 | 进入各个示例页面，push页面，点击draw sth按钮触发绘制，返回 | 画布绘制正常 | 是       | Pass     |