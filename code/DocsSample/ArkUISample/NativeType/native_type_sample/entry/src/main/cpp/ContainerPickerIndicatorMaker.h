...
#ifndef NATIVE_TYPE_SAMPLE_CONTAINER_PICKER_INDICATOR_MAKER_H
#define NATIVE_TYPE_SAMPLE_CONTAINER_PICKER_INDICATOR_MAKER_H
...
class ContainerPickerIndicatorMaker : public BaseNode {
public:
    static ArkUI_NodeHandle CreateNativeNode();

    ContainerPickerIndicatorMaker()
    ...
    ~ContainerPickerIndicatorMaker() override = default;
...
#endif // NATIVE_TYPE_SAMPLE_CONTAINER_PICKER_INDICATOR_MAKER_H