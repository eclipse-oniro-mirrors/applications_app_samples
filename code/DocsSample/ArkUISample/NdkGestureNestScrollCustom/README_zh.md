...
2.本示例为Stage模型，支持API20版本SDK，版本号：7.0.0.22，镜像版本号：OpenHarmony_7.0.0.22。
...
echo code/DocsSample/ArkUISample/NdkGestureNestScrollCustom > .git/info/sparse-checkout
