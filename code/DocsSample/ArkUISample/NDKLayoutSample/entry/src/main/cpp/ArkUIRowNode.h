 ...
 */
#ifndef NDKLAYOUTSAMPLE_ARKUIROWNODE_H
#define NDKLAYOUTSAMPLE_ARKUIROWNODE_H
...
public:
    ...
    ~ArkUIRowNode() override = default;

    void SetAlignItems(ArkUI_VerticalAlignment align)
    {
...
#endif // NDKLAYOUTSAMPLE_ARKUIROWNODE_H
