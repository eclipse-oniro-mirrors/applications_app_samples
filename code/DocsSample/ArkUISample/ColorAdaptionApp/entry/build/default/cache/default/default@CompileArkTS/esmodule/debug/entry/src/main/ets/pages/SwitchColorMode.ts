...
class DisplayPage extends ViewPU {
    ...
    setInitiallyProvidedValue(params: DisplayPage_Params) {
    ...
    updateStateVars(params: DisplayPage_Params) {
    }
...
registerNamedRoute(() => new DisplayPage(undefined, {}), "", { bundleName: "com.samples.ColorAdaption", moduleName: "entry", pagePath: "pages/SwitchColorMode", pageFullPath: "entry/src/main/ets/pages/SwitchColorMode", integratedHsp: "false", moduleType: "followWithHap" });
