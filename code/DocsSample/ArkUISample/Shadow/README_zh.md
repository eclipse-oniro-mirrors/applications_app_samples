...
1. [阴影](https://gitee.com/openharmony/docs/blob/master/zh-cn/application-dev/ui/arkts-shadow-effect.md)。
...
echo code/DocsSample/ArkUISample/Shadow > .git/info/sparse-checkout
