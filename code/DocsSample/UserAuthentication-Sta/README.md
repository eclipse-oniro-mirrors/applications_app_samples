...
| 首页                                                     | 实例1                                                       | 用户验证窗口                                                 |
| ------------------------------------------------------- | ---------------------------------------------------------- | ------------------------------------------------------------ |
| <img src="./screenshots/query.jpg" style="zoom:50%;" /> | <img src="./screenshots/example1.jpg" style="zoom:50%;" /> | <img src="./screenshots/mockLogin.jpg" style="zoom:50%;" /> |
...
echo code/DocsSample/UserAuthentication-Sta > .git/info/sparse-checkout
