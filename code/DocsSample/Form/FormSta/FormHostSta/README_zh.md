...
* 应用事件监听
  ...
  * 源码参考：[Index.ets](./entry/src/main/ets/pages/Index.ets)
  * 接口参考：[@ohos.bundle.bundleMonitor](https://gitcode.com/openharmony/docs/blob/master/zh-cn/application-dev/reference/apis-ability-kit/js-apis-bundleMonitor-sys.md)
...
echo code/DocsSample/Form/FormSta/FormHost/ > .git/info/sparse-checkout
