...
static void PasteboardFinalizeImpl2(void *context) { OH_LOG_INFO(LOG_APP, "callback: Pasteboard_Finalize"); }
...
void ProviderFinalizeCallback(void *context) { OH_LOG_INFO(LOG_APP, "OH_UdmfRecordProvider finalize."); }
