...
static int CreateJsCore(uint32_t *result)
{
    ...
    g_callBackStructMap[g_envtagNumber][0].callback = Consoleinfo;
    g_callBackStructMap[g_envtagNumber][1].callback = Add;
    g_callBackStructMap[g_envtagNumber][2].callback = AssertEqual;
    g_callBackStructMap[g_envtagNumber][3].callback = CreatePromise;
    JSVM_PropertyDescriptor descriptors[] = {
        { "consoleinfo", NULL, &g_callBackStructMap[g_envtagNumber][0], NULL, NULL, NULL, JSVM_DEFAULT },
        { "add", NULL, &g_callBackStructMap[g_envtagNumber][1], NULL, NULL, NULL, JSVM_DEFAULT },
        { "assertEqual", NULL, &g_callBackStructMap[g_envtagNumber][2], NULL, NULL, NULL, JSVM_DEFAULT },
        { "createPromise", NULL, &g_callBackStructMap[g_envtagNumber][3], NULL, NULL, NULL, JSVM_DEFAULT },
    };
