...
1. 实现指南文档[Web组件渲染模式](https://gitcode.com/openharmony/docs/blob/OpenHarmony_feature_sta_20260331/zh-cn/application-dev/web/web-render-mode.md)中示例代码片段的工程化，保证指南中示例代码与sample工程文件同源。
...
echo code/DocsSample/ArkWeb-Sta/WebRenderMode > .git/info/sparse-checkout
