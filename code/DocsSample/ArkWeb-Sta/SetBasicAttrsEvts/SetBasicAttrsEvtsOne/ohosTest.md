...
### ConfigCookieSyncThenExistCookie

| 测试功能     | 预置条件     | 输入                                                                  | 预期输出                              | 是否自动 | 测试结果 |
| ------------ | ------------ | --------------------------------------------------------------------- | ------------------------------------- | -------- | -------- |
| 使用隐私模式 | 设备运转正常 | 应用启动成功，点击configCookieSync按钮后点击existCookie按钮 | 隐私模式下能够查询到已设置的cookie | Yes      | Pass     |

### ConfigCookieSyncThenFetchCookieSync

| 测试功能     | 预置条件     | 输入                                                                      | 预期输出                                  | 是否自动 | 测试结果 |
| ------------ | ------------ | ------------------------------------------------------------------------- | ----------------------------------------- | -------- | -------- |
| 使用隐私模式 | 设备运转正常 | 应用启动成功，点击configCookieSync按钮后点击fetchCookieSync按钮 | 能够获取到隐私模式下指定url的cookie值 | Yes      | Pass     |

### ClearAllCookiesSyncThenExistCookie

| 测试功能     | 预置条件     | 输入                                                                        | 预期输出                        | 是否自动 | 测试结果 |
| ------------ | ------------ | --------------------------------------------------------------------------- | ------------------------------- | -------- | -------- |
| 使用隐私模式 | 设备运转正常 | 应用启动成功，点击clearAllCookiesSync按钮后点击existCookie按钮 | 隐私模式下查询不到cookie | Yes      | Pass     |

### AllowGeolocationThenGetAccessibleGeolocation

| 测试功能     | 预置条件     | 输入                                                                                  | 预期输出                              | 是否自动 | 测试结果 |
| ------------ | ------------ | ------------------------------------------------------------------------------------- | ------------------------------------- | -------- | -------- |
| 使用隐私模式 | 设备运转正常 | 应用启动成功，点击allowGeolocation按钮后点击getAccessibleGeolocation按钮 | 指定来源的地理位置权限状态为允许 | Yes      | Pass     |

### DeleteGeolocationThenGetAccessibleGeolocation

| 测试功能     | 预置条件     | 输入                                                                                    | 预期输出                              | 是否自动 | 测试结果 |
| ------------ | ------------ | --------------------------------------------------------------------------------------- | ------------------------------------- | -------- | -------- |
| 使用隐私模式 | 设备运转正常 | 应用启动成功，点击deleteGeolocation按钮后点击getAccessibleGeolocation按钮 | 指定来源的地理位置权限状态已被清除 | Yes      | Pass     |

### IncognitoModeNoPrivacy

| 测试功能     | 预置条件     | 输入                                                              | 预期输出                            | 是否自动 | 测试结果 |
| ------------ | ------------ | ----------------------------------------------------------------- | ----------------------------------- | -------- | -------- |
| 使用隐私模式 | 设备运转正常 | 应用启动成功，在IncognitoMode_two页面点击isIncognitoMode按钮 | 非隐私模式Web组件返回false | Yes      | Pass     |
