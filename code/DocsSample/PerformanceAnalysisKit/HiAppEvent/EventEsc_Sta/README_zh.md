...
- [事件上报](https://gitcode.com/openharmony/docs/blob/OpenHarmony_feature_sta_20260331/zh-cn/application-dev/dfx/hiappevent-event-reporting.md)
...
echo code/DocsSample/PerformanceAnalysisKit/HiAppEvent/EventEsc_Sta/ > .git/info/sparse-checkout
