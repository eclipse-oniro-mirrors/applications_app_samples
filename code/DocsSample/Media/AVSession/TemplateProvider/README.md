...
本示例主要展示了音频模板（模板提供方）的相关功能，使用[@ohos.multimedia.avMusicTemplate](https://gitee.com/openharmony/docs/blob/master/zh-cn/application-dev/reference/apis-avsession-kit/arkts-apis-avMusicTemplate.md)等接口实现音频模板提供方与音频模板控制方自定义信息的交互功能。
