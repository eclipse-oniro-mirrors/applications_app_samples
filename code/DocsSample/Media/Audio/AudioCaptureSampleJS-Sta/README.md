...
本示例基于[AudioRender](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-audiorenderer)、[AudioCapturer](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-audiocapturer)、[AVPlayer](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-avplayer)等能力，实现了音频录制、管理麦克风、音频录制流管理以及音频低时延耳返等功能，包含了功能调用接口的完整链路。
...
3.  本示例支持API version 21，版本号： 6.0.1.112。

4.  本示例已支持使Build Version: 6.0.1.112, built on November 20, 2025。
...
### 下载
 	 ...
 	 echo code/DocsSample/Media/Audio/AudioCaptureSampleJS-Sta > .git/info/sparse-checkout
