...
// NAPI argument ordinal indices (args[0] = object pointer)
inline constexpr int32_t NAPI_FIRST_PARAM = 0;
inline constexpr int32_t NAPI_SECOND_PARAM = 1;
inline constexpr int32_t NAPI_THIRD_PARAM = 2;
inline constexpr int32_t NAPI_FOURTH_PARAM = 3;
inline constexpr int32_t NAPI_FIFTH_PARAM = 4;
inline constexpr int32_t NAPI_SIXTH_PARAM = 5;
inline constexpr int32_t NAPI_SEVENTH_PARAM = 6;
inline constexpr int32_t NAPI_EIGHTH_PARAM = 7;
inline constexpr int32_t NAPI_NINTH_PARAM = 8;
inline constexpr int32_t NAPI_TENTH_PARAM = 9;
inline constexpr int32_t NAPI_ELEVENTH_PARAM = 10;
