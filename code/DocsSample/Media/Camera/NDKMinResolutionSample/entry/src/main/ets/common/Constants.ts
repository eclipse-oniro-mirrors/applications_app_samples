...
// === 新增：推荐展示顺序（只显示设备真正支持的一部分）===
export const PreferredResolutionList: string[] = [
  '2560*1440', // 标准5M 16:9
  '2408*1080',
  '2384*1080',
  '1920*1440', // vision kit 固定分辨率
  '1920*1080',
  '1440*1080',
  '1280*720',
  '1088*1088',
...
// === 新增：把 {width,height} 转成 "W*H" 字符串 ===
export function sizeToStr(w: number, h: number): string {
  return `${w}*${h}`;
}
