...
export const initCamera:(surfaceId: string, focusMode: number, cameraDeviceIndex: number,
    sceneMode: number, preconfigMode: number, preconfigType: number, preconfigRatio: number,
    photoOutputType: number, isMovingPhoto: boolean, isSavingPhoto: boolean) => number;
export const startPhotoOrVideo: (modeFlag: string, videoId: string, photoId: string, degree: number) => number;
export const videoOutputStart: () => number;
export const setZoomRatio: (a: number) => number;
export const setRequestOption: (a: number) => number;
...
export const changeRequestDiscardCameraPhoto: () => number;
export const changeRequestSaveCameraPhoto: () => number;
export const requestImage: (callback: (uri:string)=>void) => void;
export const requestImageQuality: (callback: (mediaQuality:string)=>void)  => void;
export const enableMovingPhoto: (a: boolean) => number;
export const isVideoModeAvailable: () => number;
