...
export const initCamera:(surfaceId: string, focusMode: number, cameraDeviceIndex: number,
    ...
    photoOutputType: number, videoId: string, photoId: string) => number;
...
export const requestImage: (callback: Callback<string>) => void;
export const requestImageQuality: (callback: Callback<string>) => void;
// export const requestImage: () => void;
