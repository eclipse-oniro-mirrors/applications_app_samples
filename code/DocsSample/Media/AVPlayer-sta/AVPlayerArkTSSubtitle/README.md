...
本示例为媒体->Media Kit(媒体服务)->[使用AVPlayer添加视频外挂字幕(ArkTS)](https://gitcode.com/openharmony/docs/blob/master/zh-cn/application-dev/media/media/video-subtitle.md)的配套示例工程。 
...
echo code/DocsSample/Media/AVPlayer-sta/AVPlayerArkTSSubtitle/ > .git/info/sparse-checkout
