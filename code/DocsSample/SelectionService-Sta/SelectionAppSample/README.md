...
## 介绍
 ...
 本示例通过提供[划词服务指南文档](https://gitcode.com/openharmony/docs/tree/OpenHarmony_feature_sta_20260331/zh-cn/application-dev/basic-services/selectionInput)中ArkTS场景的开发示例，帮助开发者更好地理解划词服务模块代码的使用。该工程中展示的代码详细描述可查如下链接：

1. [实现一个划词应用](https://gitcode.com/openharmony/docs/blob/OpenHarmony_feature_sta_20260331/zh-cn/application-dev/basic-services/selectionInput/selection-services-application-guide.md)。
