...
export default function abilityTest() {
    describe('ActsAbilityTest', () => {
        ...
        /**
         * @tc.number    SUB_AppLink1
         * @tc.name      SUB_AppLink1
         * @tc.desc      test AppLink1
         * @tc.level     Level1
         * @tc.size      MediumTest
         * @tc.type      Function
         */
        it('SUB_AppLink1', 0, async (done: Function) => {
            ...
            try {
                ...
                const want: Want = {
                    deviceId: '',
                    bundleName: 'com.example.applinking',
        ...
        /**
         * @tc.number    SUB_AppLink2
         * @tc.name      SUB_AppLink12
         * @tc.desc      test AppLink2
         * @tc.level     Level1
         * @tc.size      MediumTest
         * @tc.type      Function
         */
        it('SUB_AppLink2', 0, async (done: Function) => {
            hilog.info(DOMAIN_NUMBER, TAG, 'uitest: TestUiExample begin');
            try {
                const delegator: abilityDelegatorRegistry.AbilityDelegator = abilityDelegatorRegistry.getAbilityDelegator();
                const bundleName = abilityDelegatorRegistry.getArguments().bundleName;
                const want: Want = {
                    deviceId: '',
                    bundleName: 'com.example.applinking',
                    abilityName: 'AppLinkEntryAbility'
                };
                await delegator.startAbility(want);
                // const ability: UIAbility = await delegator.getCurrentTopAbility();
                await sleep(5000);
