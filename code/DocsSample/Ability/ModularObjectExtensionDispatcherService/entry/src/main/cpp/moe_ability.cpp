...
#include "TaiHe/test_main_service_stub.h"
#include "TaiHe/test_main_service_stub_impl.h"
// [StartExclude modular_object_extension_moe_ability]
...
static std::map<OH_AbilityRuntime_ModObjExtensionInstanceHandle, OH_AbilityRuntime_ModObjExtensionContextHandle>
    g_contextMap;
static std::map<OH_AbilityRuntime_ModObjExtensionInstanceHandle, OHOS::IPC::TestMainServiceStub *> g_stubMap;
...
static OHIPCRemoteStub *OnConnect(OH_AbilityRuntime_ModObjExtensionInstanceHandle instance, AbilityBase_Want *want)
{
    ...
    OHOS::IPC::TestMainServiceStub *stub = new OHOS::IPC::TestMainServiceStubImpl(context);
...
static void OnDisconnect(OH_AbilityRuntime_ModObjExtensionInstanceHandle instance)
{
    ...
    // 断连时清理Stub
    OHOS::IPC::TestMainServiceStub *stub = g_stubMap.at(instance);
    if (stub != nullptr) {
        delete stub;
