    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.onClick(() => {
                ...
                // }
                let link: string = 'links://www.example.com';
...
registerNamedRoute(() => new Index(undefined, {}), "", { bundleName: "com.example.pulllinking", moduleName: "entry", pagePath: "pages/WantAbilityPage1", pageFullPath: "entry/src/main/ets/pages/WantAbilityPage1", integratedHsp: "false", moduleType: "followWithHap" });
