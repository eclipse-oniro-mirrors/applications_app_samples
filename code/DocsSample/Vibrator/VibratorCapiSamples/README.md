...
本示例用到了vibrator相关接口操作[@kit.SensorServiceKit](https://gitcode.com/openharmony/docs/blob/master/zh-cn/application-dev/reference/apis-sensor-service-kit/capi-vibrator.md)
...
echo code/DocsSample/Vibrator/VibratorCapiSamples/ > .git/info/sparse-checkout  
