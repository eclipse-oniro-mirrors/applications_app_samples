...
1.进入应用，首次进入需要授予蓝牙权限，点击蓝牙断开重连进入二级页面，然后点击申请蓝牙长时任务及注册暂停回调。

2.点击注册蓝牙设备监听及注册蓝牙连接状态监听，点击开始蓝牙扫描，首次扫描到对端设备需要进行连接授权。
...
进入应用，首次进入需要授予蓝牙权限，点击蓝牙断开重连进入二级页面，然后点击gattServerTest并置于前台。
