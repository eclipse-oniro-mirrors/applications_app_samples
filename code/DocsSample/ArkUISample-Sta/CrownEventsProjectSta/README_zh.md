...
本示例为[支持表冠输入事件](https://gitcode.com/openharmony/docs/blob/OpenHarmony_feature_sta_20260331/zh-cn/application-dev/ui/arkts-common-events-crown-event.md)的配套示例工程。
