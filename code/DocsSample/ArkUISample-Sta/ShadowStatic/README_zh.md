...
1. [阴影](https://gitcode.com/openharmony/docs/blob/OpenHarmony_feature_sta_20260331/zh-cn/application-dev/ui/arkts-shadow-effect.md)。
...
echo code/DocsSample/ArkUISample-Sta/ShadowStatic > .git/info/sparse-checkout
