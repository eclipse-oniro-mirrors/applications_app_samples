...
本示例展示了[UI国际化](https://gitcode.com/openharmony/docs/blob/OpenHarmony_feature_sta_20260331/zh-cn/application-dev/ui/arkts-internationalization.md)的使用方法：
...
echo code/DocsSample/ArkUISample-Sta/GradientEffect > .git/info/sparse-checkout
