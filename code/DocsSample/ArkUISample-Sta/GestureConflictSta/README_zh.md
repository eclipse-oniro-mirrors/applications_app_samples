...
本示例为[手势冲突处理](https://gitcode.com/openharmony/docs/blob/OpenHarmony_feature_sta_20260331/zh-cn/application-dev/ui/arkts-gesture-events-gesture-judge.md)的配套示例工程。
...
2. 本示例支持API23版本SDK，版本号：6.0.0.47;
