...
### 示例文档
[多层级手势事件](https://gitcode.com/openharmony/docs/blob/OpenHarmony_feature_sta_20260331/zh-cn/application-dev/ui/arkts-gesture-events-multi-level-gesture.md)。
...
2.本示例为Stage模型，支持API23版本SDK，版本号：6.0.0.33，镜像版本号：OpenHarmony_6.0.0.33。
