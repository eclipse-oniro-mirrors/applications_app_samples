...
1. [绘制几何图形](https://gitcode.com/openharmony/docs/blob/OpenHarmony_feature_sta_20260331/zh-cn/application-dev/ui/arkts-geometric-shape-drawing.md)。
...
echo code/DocsSample/ArkUISample-Sta/ShapeDrawing > .git/info/sparse-checkout
