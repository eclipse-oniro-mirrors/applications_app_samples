...
1. [支持焦点处理](https://gitcode.com/openharmony/docs/blob/OpenHarmony_feature_sta_20260331/zh-cn/application-dev/ui/arkts-common-events-focus-event.md)
2. [支持统一拖拽](https://gitcode.com/openharmony/docs/blob/OpenHarmony_feature_sta_20260331/zh-cn/application-dev/ui/arkts-common-events-drag-event.md)
3. [单一手势](https://gitcode.com/openharmony/docs/blob/OpenHarmony_feature_sta_20260331/zh-cn/application-dev/ui/arkts-gesture-events-single-gesture.md)
4. [组合手势](https://gitcode.com/openharmony/docs/blob/OpenHarmony_feature_sta_20260331/zh-cn/application-dev/ui/arkts-gesture-events-combined-gestures.md)
5. [手势冲突处理](https://gitcode.com/openharmony/docs/blob/OpenHarmony_feature_sta_20260331/zh-cn/application-dev/ui/arkts-gesture-events-gesture-judge.md)
6. [支持键盘输入事件](https://gitcode.com/openharmony/docs/blob/OpenHarmony_feature_sta_20260331/zh-cn/application-dev/ui/arkts-interaction-development-guide-keyboard.md)
### 效果预览
...
2.本示例为Stage模型，支持API24版本SDK，版本号：6.1.0.30，镜像版本号：OpenHarmony 6.1.0.30。
