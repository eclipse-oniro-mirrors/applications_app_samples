...
#ifndef NATIVE_TYPE_SAMPLE_CONTAINER_PICKER_TIME_MAKER_H
#define NATIVE_TYPE_SAMPLE_CONTAINER_PICKER_TIME_MAKER_H
...
class ContainerPickerTimeMaker : public BaseNode {
public:
    static ArkUI_NodeHandle CreateNativeNode();

    ContainerPickerTimeMaker()
    ...
    ~ContainerPickerTimeMaker() override = default;
...
#endif // NATIVE_TYPE_SAMPLE_CONTAINER_PICKER_TIME_MAKER_H