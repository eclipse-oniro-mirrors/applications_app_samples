...
#ifndef NATIVE_TYPE_SAMPLE_CONTAINER_PICKER_INDEX_MAKER_H
#define NATIVE_TYPE_SAMPLE_CONTAINER_PICKER_INDEX_MAKER_H
...
class ContainerPickerIndexMaker : public BaseNode {
public:
    static ArkUI_NodeHandle CreateNativeNode();

    ContainerPickerIndexMaker()
    ...
    ~ContainerPickerIndexMaker() override = default;
...
#endif // NATIVE_TYPE_SAMPLE_CONTAINER_PICKER_INDEX_MAKER_H