...
#ifndef NATIVE_TYPE_SAMPLE_CONTAINER_PICKER_MONTH_MAKER_H
#define NATIVE_TYPE_SAMPLE_CONTAINER_PICKER_MONTH_MAKER_H
...
class ContainerPickerMonthMaker : public BaseNode {
public:
    static ArkUI_NodeHandle CreateNativeNode();

    ContainerPickerMonthMaker()
    ...
    ~ContainerPickerMonthMaker() override = default;
...
#endif // NATIVE_TYPE_SAMPLE_CONTAINER_PICKER_MONTH_MAKER_H