...
#ifndef NATIVE_TYPE_SAMPLE_CONTAINER_PICKER_TYPES_MAKER_H
#define NATIVE_TYPE_SAMPLE_CONTAINER_PICKER_TYPES_MAKER_H
...
class ContainerPickerTypesMaker : public BaseNode {
public:
    static ArkUI_NodeHandle CreateNativeNode();

    ContainerPickerTypesMaker()
    ...
    ~ContainerPickerTypesMaker() override = default;
...
#endif // NATIVE_TYPE_SAMPLE_CONTAINER_PICKER_TYPES_MAKER_H