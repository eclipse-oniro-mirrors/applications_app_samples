...
#ifndef NATIVE_TYPE_SAMPLE_CONTAINER_PICKER_EVENTS_MAKER_H
#define NATIVE_TYPE_SAMPLE_CONTAINER_PICKER_EVENTS_MAKER_H
...
class ContainerPickerEventsMaker : public BaseNode {
public:
    static ArkUI_NodeHandle CreateNativeNode();

    ContainerPickerEventsMaker()
    ...
    ~ContainerPickerEventsMaker() override = default;
...
#endif // NATIVE_TYPE_SAMPLE_CONTAINER_PICKER_EVENTS_MAKER_H