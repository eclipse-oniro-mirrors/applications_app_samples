...
#ifndef NATIVE_TYPE_SAMPLE_CONTAINER_PICKER_REGION_MAKER_H
#define NATIVE_TYPE_SAMPLE_CONTAINER_PICKER_REGION_MAKER_H
...
class ContainerPickerRegionMaker : public BaseNode {
public:
    static ArkUI_NodeHandle CreateNativeNode();

    ContainerPickerRegionMaker()
    ...
    ~ContainerPickerRegionMaker() override = default;
...
#endif // NATIVE_TYPE_SAMPLE_CONTAINER_PICKER_REGION_MAKER_H