...
全文以 **音乐播放** 为示例场景，贯穿 `example-org-music-assistant` 这一 Skill 的完整开发过程。
...
| 步骤 | 关键文件 |
| ---- | -------- |
| 1. 创建目录与文件 | `entry/skills/example-org-music-assistant/` |
| 2. 配置 module.json5 | `entry/src/main/module.json5` |
| 3. 实现 ETS 函数 | `entry/skills/example-org-music-assistant/scripts/MusicSkill.ets` |
| 4. 编写 SKILL.md | `entry/skills/example-org-music-assistant/SKILL.md` |
