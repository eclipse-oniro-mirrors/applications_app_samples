...
|                                      首页                                       |                               Actor模型示例                                |                               Actor模型示例2                                |
| :-----------------------------------------------------------------------------: | :-----------------------------------------------------------------------------: | :-----------------------------------------------------------------------------: |
| <img src="./screenshots/Multi_home.png" style="zoom: 50%;" /> | <img src="./screenshots/Multi_actor1.png" style="zoom: 50%;" /> | <img src="./screenshots/Multi_actor2.png" style="zoom: 50%;" /> |

### 使用说明

1. 在首页，点击"Actor模型示例"按钮，进入Actor模型示例页面。
2. 在首页，点击"Actor模型示例2"按钮，进入Actor模型示例2页面。
3. 在Actor模型示例页面，可以点击"Actor start"、"Actor start2"、"cale start"按钮执行相应操作，执行结果会即时反馈在屏幕中央，并在控制台打印log。
4. 在Actor模型示例2页面，点击"start"按钮执行生产任务，等待所有生产完成后统一消费结果。
...
entry/src/
 ...
 │   │   ├── entrybackupability
 │   │   ├── managers
 │   │   │   ├── actormodel.ets         // Actor模型示例代码
 │   │   │   ├── actormodel2.ets        // Actor模型示例2代码
 │   │   │   ├── Cale.ets               // 内存共享模型示例代码
 │   │   ├── pages
 │   │   │   ├── Index.ets              // 首页导航
 │   │   ├── util
