...
| 文件路径注意事项         | 位于CreateWorker.ets          | 点击Hello World | 1秒后页面显示“success” | 是       | Pass     |
| Stage模型下的文件路径规则1 | 位于StageRulesFa.ets         | 点击Hello World | 1秒后页面显示“success” | 是       | Pass     |
| Stage模型下的文件路径规则2 | 位于StageRulesHar.ets | 点击Hello World | 1秒后页面显示“success” | 是       | Pass     |
| Stage模型下的文件路径规则3 | 位于StageRulesThreadFile.ets | 点击Hello World | 1秒后页面显示“success” | 是       | Pass     |