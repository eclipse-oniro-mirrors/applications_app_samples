    ...
    async onRun() {
        ...
        abilityDelegator.executeShellCommand(cmd,
            (err, data) => {
                ...
                hilog.info(DOMAIN, TAG, 'executeShellCommand : data : %{public}s', data.stdResult ?? '');
                hilog.info(DOMAIN, TAG, 'executeShellCommand : data : %{public}s', data.exitCode ?? '');
            });
