...
| 主页按钮点击  | 位于主页         | 点击”空间音频“       | 跳转空间音频页面            | 是    | pass |
| 空间音频-播放2.0音乐示例  |  空间音频页面  | 点击“2.0音乐示例”播放器播放按钮      |音频开始播放| 是    | pass |
| 空间音频-暂停2.0音乐示例  |  空间音频页面  | 点击“2.0音乐示例”播放器暂停按钮      |音频暂停播放| 是    | pass |
| 返回主页  |  空间音频页面  | 点击返回按钮     |返回到主页面| 是    | pass |
| 主页按钮点击  | 位于主页         | 点击”k歌“       | 跳转k歌界面页面            | 是    | pass |
| k歌-创建耳返  |  k歌界面页面  | 点击“初始化”按钮      |创建耳返| 是    | pass |
| k歌-开启耳返  | k歌界面页面  | 点击“开启耳返”按钮      |开启耳返| 是    | pass |
| k歌-停止耳返  | k歌界面页面  | 点击“停止耳返”按钮      |停止耳返| 是    | pass |
| 返回主页  |  k歌界面页面  | 点击返回按钮     |返回到主页面| 是    | pass |