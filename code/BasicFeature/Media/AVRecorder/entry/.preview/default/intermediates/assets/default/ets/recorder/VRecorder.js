...
/***/ "D:\\avRecorder\\applications_app_samples\\media\\AVRecorder\\entry\\src\\main\\ets\\recorder\\VRecorder.ets?entry":
/*!***************************************************************************************************************!*\
  !*** D:\avRecorder\applications_app_samples\media\AVRecorder\entry\src\main\ets\recorder\VRecorder.ets?entry ***!
  \***************************************************************************************************************/
...
class videoRecording extends View {
    ...
    render() {
        Column.create();
        Column.debugLine("recorder/VRecorder.ets(575:5)");
        Row.create();
        Row.debugLine("recorder/VRecorder.ets(576:7)");
        Stack.create({ alignContent: Alignment.Center });
        Stack.debugLine("recorder/VRecorder.ets(577:9)");
        Stack.width('100%');
        Stack.height('100%');
        XComponent.create({
            id: 'xcomponent1',
        ...
        XComponent.debugLine("recorder/VRecorder.ets(578:11)");
        XComponent.onLoad(() => {
        ...
        Text.debugLine("recorder/VRecorder.ets(591:11)");
        ...
        if (!this.isStartRecording) {
            ...
            Image.debugLine("recorder/VRecorder.ets(599:13)");
            Image.width(40);
            Image.height(40);
            ...
            Image.debugLine("recorder/VRecorder.ets(610:13)");
            Image.width(12);
            Image.height(12);
            Image.margin({ left: 136, top: 25, right: 212, bottom: 715 });
            Image.create(this.startRecordingBtn);
            Image.debugLine("recorder/VRecorder.ets(614:13)");
            Image.width(86);
            Image.height(86);
            ...
            Image.debugLine("recorder/VRecorder.ets(622:13)");
            Image.width(120);
            Image.height(56);
            Image.margin({ left: 120, top: 632, right: 120, bottom: 92 });
            Image.create(this.stopRecordingBtn);
            Image.debugLine("recorder/VRecorder.ets(626:13)");
            Image.width(16);
            Image.height(16);
            ...
            if (!this.isPauseRecording) {
                If.branchId(0);
                Image.create(this.recordingBtn);
                Image.debugLine("recorder/VRecorder.ets(633:15)");
                Image.width(12);
                Image.height(12);
                Image.margin({ left: 136, top: 25, right: 212, bottom: 715 });
                Image.create(this.pauseRecordingBtn);
                Image.debugLine("recorder/VRecorder.ets(637:15)");
                Image.width(14);
                Image.height(15);
                ...
                Image.debugLine("recorder/VRecorder.ets(644:15)");
                Image.width(14);
                Image.height(14);
                Image.margin({ left: 136, top: 25, right: 212, bottom: 715 });
                Image.create(this.resumeRecordingBtn);
                Image.debugLine("recorder/VRecorder.ets(648:15)");
                Image.width(16);
                Image.height(16);
...
class CustomDialogSetting extends View {
    ...
    render() {
        Column.create();
        Column.debugLine("recorder/VRecorder.ets(717:5)");
        Column.margin({ left: 12, right: 12, bottom: 12 });
        Column.backgroundColor('#FFFFFF');
        Column.borderRadius(32);
        Column.alignItems(HorizontalAlign.Center);
        Column.create();
        Column.debugLine("recorder/VRecorder.ets(718:7)");
        Column.alignItems(HorizontalAlign.Start);
        Text.create('选择视频分辨率');
        Text.debugLine("recorder/VRecorder.ets(719:9)");
        ...
        Text.pop();
        Column.create();
        Column.debugLine("recorder/VRecorder.ets(725:9)");
        Column.margin({ left: 24, right: 24, top: 16 });
        List.create({ space: 10 });
        List.debugLine("recorder/VRecorder.ets(726:11)");
        ...
        ForEach.create("3", this, ObservedObject.GetRawObject(this.videoResolutionList), (item, index) => {
            ListItem.create();
            ListItem.debugLine("recorder/VRecorder.ets(728:15)");
            Row.create();
            Row.debugLine("recorder/VRecorder.ets(729:17)");
            Row.margin({ left: 0, right: 39 });
            Text.create('视频分辨率： ' + item.itemValue.toString());
            Text.debugLine("recorder/VRecorder.ets(730:19)");
            Text.fontSize(16);
            Text.width('100%');
            Text.fontFamily('HarmonyHeiTi-Medium');
            Text.pop();
            Radio.create({ value: item.value.toString(), group: 'radioGroup' });
            Radio.debugLine("recorder/VRecorder.ets(734:19)");
        ...
        Column.pop();
        Row.create();
        Row.debugLine("recorder/VRecorder.ets(751:7)");
        Row.width(300);
        Row.height(40);
        Row.margin({ left: 24, right: 24, top: 12, bottom: 16 });
        Button.createWithLabel('取消');
        Button.debugLine("recorder/VRecorder.ets(752:9)");
        Button.onClick(() => {
        ...
        Button.pop();
        Divider.create();
        Divider.debugLine("recorder/VRecorder.ets(766:9)");
        ...
        Button.debugLine("recorder/VRecorder.ets(772:9)");
        Button.onClick(() => {
...
/******/ 	var __webpack_exports__ = __webpack_require__("D:\\avRecorder\\applications_app_samples\\media\\AVRecorder\\entry\\src\\main\\ets\\recorder\\VRecorder.ets?entry");
