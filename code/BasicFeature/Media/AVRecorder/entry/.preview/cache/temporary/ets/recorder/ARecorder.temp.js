...
/***/ "D:\\avRecorder\\applications_app_samples\\media\\AVRecorder\\entry\\src\\main\\ets\\recorder\\ARecorder.ets?entry":
/*!***************************************************************************************************************!*\
  !*** D:\avRecorder\applications_app_samples\media\AVRecorder\entry\src\main\ets\recorder\ARecorder.ets?entry ***!
  \***************************************************************************************************************/
...
const DateTimeUtils_1 = __webpack_require__(/*! ../utils/DateTimeUtils */ "D:\\avRecorder\\applications_app_samples\\media\\AVRecorder\\entry\\src\\main\\ets\\utils\\DateTimeUtils.ets");
const Logger_1 = __importDefault(__webpack_require__(/*! ../utils/Logger */ "D:\\avRecorder\\applications_app_samples\\media\\AVRecorder\\entry\\src\\main\\ets\\utils\\Logger.ets"));
const SaveCameraAsset_1 = __importDefault(__webpack_require__(/*! ../utils/SaveCameraAsset */ "D:\\avRecorder\\applications_app_samples\\media\\AVRecorder\\entry\\src\\main\\ets\\utils\\SaveCameraAsset.ets"));
...
class audioRecording extends View {
    constructor(compilerAssignedUniqueChildId, parent, params) {
        ...
        this.mFileAssetId = 0;
        this.startRecordingBtn = { "id": 16777220, "type": 20000, params: [], "bundleName": "com.samples.avrecorder", "moduleName": "entry" };
        this.stopRecordingBtn = { "id": 16777236, "type": 20000, params: [], "bundleName": "com.samples.avrecorder", "moduleName": "entry" };
        this.pauseRecordingBtn = { "id": 16777285, "type": 20000, params: [], "bundleName": "com.samples.avrecorder", "moduleName": "entry" };
        this.resumeRecordingBtn = { "id": 16777219, "type": 20000, params: [], "bundleName": "com.samples.avrecorder", "moduleName": "entry" };
        this.settingBtn = { "id": 16777280, "type": 20000, params: [], "bundleName": "com.samples.avrecorder", "moduleName": "entry" };
        this.groupBtn = { "id": 16777286, "type": 20000, params: [], "bundleName": "com.samples.avrecorder", "moduleName": "entry" };
        this.recordingBtn = { "id": 16777288, "type": 20000, params: [], "bundleName": "com.samples.avrecorder", "moduleName": "entry" };
        this.pausedBtn = { "id": 16777279, "type": 20000, params: [], "bundleName": "com.samples.avrecorder", "moduleName": "entry" };
    ...
    updateWithValueParams(params) {
        ...
        if (params.startRecordingBtn !== undefined) {
            this.startRecordingBtn = params.startRecordingBtn;
        }
        if (params.stopRecordingBtn !== undefined) {
            this.stopRecordingBtn = params.stopRecordingBtn;
        }
        if (params.pauseRecordingBtn !== undefined) {
            this.pauseRecordingBtn = params.pauseRecordingBtn;
        }
        if (params.resumeRecordingBtn !== undefined) {
            this.resumeRecordingBtn = params.resumeRecordingBtn;
        }
        if (params.settingBtn !== undefined) {
            this.settingBtn = params.settingBtn;
        }
        if (params.groupBtn !== undefined) {
            this.groupBtn = params.groupBtn;
        }
        if (params.recordingBtn !== undefined) {
            this.recordingBtn = params.recordingBtn;
        }
        if (params.pausedBtn !== undefined) {
            this.pausedBtn = params.pausedBtn;
        }
    ...
    render() {
        Column.create();
        Column.debugLine("recorder/ARecorder.ets(273:5)");
        Row.create();
        Row.debugLine("recorder/ARecorder.ets(274:7)");
        Row.backgroundColor(Color.Black);
        Stack.create({ alignContent: Alignment.Center });
        Stack.debugLine("recorder/ARecorder.ets(275:9)");
        Stack.width('100%');
        Stack.height('100%');
        Text.create(this.audioRecorderTimeText);
        Text.debugLine("recorder/ARecorder.ets(276:11)");
        ...
        if (!this.isStartRecording) {
            If.branchId(0);
            Image.create(this.settingBtn);
            Image.debugLine("recorder/ARecorder.ets(284:13)");
            Image.width(40);
            Image.height(40);
            ...
            Image.create(this.recordingBtn);
            Image.debugLine("recorder/ARecorder.ets(295:13)");
            Image.width(12);
            Image.height(12);
            Image.margin({ left: 136, top: 25, right: 212, bottom: 715 });
            Image.create(this.startRecordingBtn);
            Image.debugLine("recorder/ARecorder.ets(299:13)");
            Image.width(86);
            Image.height(86);
            ...
            If.branchId(1);
            Image.create(this.groupBtn);
            Image.debugLine("recorder/ARecorder.ets(307:13)");
            Image.width(120);
            Image.height(56);
            Image.margin({ left: 120, top: 632, right: 120, bottom: 92 });
            Image.create(this.stopRecordingBtn);
            Image.debugLine("recorder/ARecorder.ets(311:13)");
            Image.width(16);
            Image.height(16);
            ...
            if (!this.isPauseRecording) {
                If.branchId(0);
                Image.create(this.recordingBtn);
                Image.debugLine("recorder/ARecorder.ets(318:15)");
                Image.width(12);
                Image.height(12);
                Image.margin({ left: 136, top: 25, right: 212, bottom: 715 });
                Image.create(this.pauseRecordingBtn);
                Image.debugLine("recorder/ARecorder.ets(322:15)");
                Image.width(14);
                Image.height(15);
                Image.margin({ left: 200, top: 652.5, right: 146, bottom: 112.5 });
                Image.onClick(() => this.pauseRecordingProcess());
                Image.id('audioPause');
            }
            else {
                If.branchId(1);
                Image.create(this.pausedBtn);
                Image.debugLine("recorder/ARecorder.ets(329:15)");
                Image.width(14);
                Image.height(14);
                Image.margin({ left: 136, top: 25, right: 212, bottom: 715 });
                Image.create(this.resumeRecordingBtn);
                Image.debugLine("recorder/ARecorder.ets(333:15)");
                Image.width(16);
                Image.height(16);
...
class CustomDialogSetting extends View {
    ...
    updateWithValueParams(params) {
        ...
        if (params.isChosen !== undefined) {
            this.isChosen = params.isChosen;
        }
    ...
    render() {
        Column.create();
        Column.debugLine("recorder/ARecorder.ets(389:5)");
        Column.margin({ left: 12, right: 12, bottom: 12 });
        Column.backgroundColor('#FFFFFF');
        Column.borderRadius(32);
        Column.alignItems(HorizontalAlign.Center);
        Column.create();
        Column.debugLine("recorder/ARecorder.ets(390:7)");
        Column.alignItems(HorizontalAlign.Start);
        Text.create('选择音频采样率');
        Text.debugLine("recorder/ARecorder.ets(391:9)");
        ...
        Text.pop();
        Column.create();
        Column.debugLine("recorder/ARecorder.ets(397:9)");
        Column.margin({ left: 24, right: 24, top: 16 });
        List.create({ space: 10 });
        List.debugLine("recorder/ARecorder.ets(398:11)");
        ...
        ForEach.create("3", this, ObservedObject.GetRawObject(this.audioSampleRateList), (item, index) => {
            ListItem.create();
            ListItem.debugLine("recorder/ARecorder.ets(400:15)");
            Row.create();
            Row.debugLine("recorder/ARecorder.ets(401:17)");
            Row.margin({ left: 0, right: 39 });
            Text.create('音频采样率： ' + item.toString());
            Text.debugLine("recorder/ARecorder.ets(402:19)");
            Text.fontSize(16);
            Text.width('100%');
            Text.pop();
            If.create();
            if (item == this.initAudioSampleRate) {
                ...
                Radio.debugLine("recorder/ARecorder.ets(406:21)");
                Radio.checked(true);
                Radio.height(20);
                ...
                If.branchId(1);
                Radio.create({ value: item.toString(), group: 'radioGroup2' });
                Radio.debugLine("recorder/ARecorder.ets(416:21)");
                Radio.checked(false);
                Radio.height(20);
                Radio.onChange((isChecked) => {
                    if (isChecked) {
        ...
        Column.pop();
        Row.create();
        Row.debugLine("recorder/ARecorder.ets(432:7)");
        Row.width(300);
        Row.height(40);
        Row.margin({ top: 12, bottom: 16 });
        Button.createWithLabel('取消');
        Button.debugLine("recorder/ARecorder.ets(433:9)");
        Button.onClick(() => {
        ...
        Button.pop();
        Divider.create();
        Divider.debugLine("recorder/ARecorder.ets(446:9)");
        ...
        Button.debugLine("recorder/ARecorder.ets(447:9)");
        Button.onClick(() => {
...
/***/ "D:\\avRecorder\\applications_app_samples\\media\\AVRecorder\\entry\\src\\main\\ets\\utils\\DateTimeUtils.ets":
/*!**********************************************************************************************************!*\
  !*** D:\avRecorder\applications_app_samples\media\AVRecorder\entry\src\main\ets\utils\DateTimeUtils.ets ***!
  \**********************************************************************************************************/
...
/***/ "D:\\avRecorder\\applications_app_samples\\media\\AVRecorder\\entry\\src\\main\\ets\\utils\\Logger.ets":
/*!***************************************************************************************************!*\
  !*** D:\avRecorder\applications_app_samples\media\AVRecorder\entry\src\main\ets\utils\Logger.ets ***!
  \***************************************************************************************************/
...
/***/ "D:\\avRecorder\\applications_app_samples\\media\\AVRecorder\\entry\\src\\main\\ets\\utils\\SaveCameraAsset.ets":
/*!************************************************************************************************************!*\
  !*** D:\avRecorder\applications_app_samples\media\AVRecorder\entry\src\main\ets\utils\SaveCameraAsset.ets ***!
  \************************************************************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const DateTimeUtils_1 = __importDefault(__webpack_require__(/*! ./DateTimeUtils */ "D:\\avRecorder\\applications_app_samples\\media\\AVRecorder\\entry\\src\\main\\ets\\utils\\DateTimeUtils.ets"));
const Logger_1 = __importDefault(__webpack_require__(/*! ./Logger */ "D:\\avRecorder\\applications_app_samples\\media\\AVRecorder\\entry\\src\\main\\ets\\utils\\Logger.ets"));
class SaveCameraAsset {
    ...
    async createVideoFd() {
        ...
        Logger_1.default.info(`${this.tag} get Recorder File Fd publicPath: ${media}`);
        ...
        try {
            ...
            if (dataUri != undefined) {
                ...
                Logger_1.default.info(`${this.tag} get Recorder File fd is: ` + fdNumber);
                return fdNumber;
            }
        }
        catch (err) {
...
/******/ 	var __webpack_exports__ = __webpack_require__("D:\\avRecorder\\applications_app_samples\\media\\AVRecorder\\entry\\src\\main\\ets\\recorder\\ARecorder.ets?entry");
