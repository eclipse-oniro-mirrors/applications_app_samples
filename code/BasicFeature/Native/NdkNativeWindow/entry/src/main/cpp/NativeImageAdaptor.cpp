...
NativeImageAdaptor NativeImageAdaptor::imageAdaptor_;
OH_NativeXComponent_Callback NativeImageAdaptor::callback_;
OHNativeWindow *NativeImageAdaptor::nativeWindow_;
OH_NativeImage *NativeImageAdaptor::image_;
int32_t NativeImageAdaptor::height_;
int32_t NativeImageAdaptor::width_;
int32_t NativeImageAdaptor::availableBufferCount_;
EGLConfig NativeImageAdaptor::config_;
EGLContext NativeImageAdaptor::eglContext_;
EGLDisplay NativeImageAdaptor::eglDisplay_;
std::mutex NativeImageAdaptor::opMutex_;
...
{
    // Obtain NativeWindowBuffer from NativeWindow.
...
napi_value NativeImageAdaptor::GetAvailableCount(napi_env env, napi_callback_info info)
{
    ...
    (void)napi_create_int32(env, availableBufferCount_, &val);
    return val;
}
