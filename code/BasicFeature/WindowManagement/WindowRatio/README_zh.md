...
1.安装[WindowRatio](./)工程hap包(即本示例)和[WindowManage](../WindowManage)工程hap包
...
本示例需要依赖[WindowManage](../WindowManage) sample，[WindowManage](../WindowManage) sample会在子窗口中拉起本应用，然后在本应用中设置窗口缩放比例并监听本应用的窗口大小。
