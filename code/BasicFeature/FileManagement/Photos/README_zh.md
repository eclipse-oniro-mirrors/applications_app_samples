...
2. 本示例仅支持API10版本SDK，版本号：4.0.10.10，镜像版本号：OpenHarmony 4.0.10.10，需要手动替换Full SDK才能编译通过，具体操作可参考[替换指南](https://docs.openharmony.cn/pages/v3.2/zh-cn/application-dev/quick-start/full-sdk-switch-guide.md/)；
3. 本示例需要使用DevEco Studio 4.0 Beta2 (Build Version: 4.0.0.400, built on August 2, 2023)才可编译运行，需要配置"apl":"system_basic"才可安装成功；
