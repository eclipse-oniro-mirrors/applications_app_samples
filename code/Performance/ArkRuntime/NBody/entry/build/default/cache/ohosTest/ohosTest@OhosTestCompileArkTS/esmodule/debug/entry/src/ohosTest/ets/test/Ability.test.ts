import Logger from "@bundle:com.example.nbody/entry_test/ets/util/Logger";
import type Want from "@ohos:app.ability.Want";
import AbilityDelegatorRegistry from "@ohos:app.ability.abilityDelegatorRegistry";
import { Driver, ON } from "@ohos:UiTest";
import type { Component } from "@ohos:UiTest";
import { describe, it, expect } from "@package:pkg_modules/.ohpm/@ohos+hypium@1.0.6/pkg_modules/@ohos/hypium/index";
...
export default function abilityTest() {
    describe('ActsAbilityTest', () => {
        ...
        it(BUNDLE + '_StartTaskPoolCalculate_001', 0, async (done: Function) => {
            ...
            await driver.delayMs(1000);
            // 判断弹窗是否弹出
            await driver.assertComponentExist(ON.text(getResourceString({ "id": 33554434, "type": 10003, params: [], "bundleName": "com.example.nbody", "moduleName": "entry_test" })));
            await driver.delayMs(500);
            // 找到确认按钮，关闭弹窗
            let alertDialogClose: Component = await driver.findComponent(ON.text(getResourceString({ "id": 33554435, "type": 10003, params: [], "bundleName": "com.example.nbody", "moduleName": "entry_test" })));
            ...
            await driver.delayMs(500);
            // 找到确认按钮，关闭弹窗
            alertDialogClose = await driver.findComponent(ON.text(getResourceString({ "id": 33554435, "type": 10003, params: [], "bundleName": "com.example.nbody", "moduleName": "entry_test" })));
            await alertDialogClose.click();
