 ...
 * @since 2022/9/8
 */
export declare abstract class AbstractCompileResource extends OhosHapTask {
    ...
    processResourceTask: AbstractProcessResource | undefined;
     ...
     * @protected
     */
    protected compilationProcess(commandType: string, targetData: ModuleTargetData): void;
    /**
     * 资源编译前置检查
     *
     ...
     * @param {ModuleTargetData} targetData
     */
    invokeRestool(targetData: ModuleTargetData): void;
    /**
     * 同步执行命令
     *
     ...
     * @protected
     */
    protected executeCommandSync(commands: string[], log: OhosLogger, callback?: Function): void;
    /**
     ...
     * @protected
     */
    protected compileLink(log: OhosLogger, callback?: Function): void;
     ...
     */
    previewCompileLink(log: OhosLogger, callback?: Function): void;
    /**
     * Preview 构建参数持久化
     * （预览热加载时使用此参数）
     */
    previewBuildParamPersistence(): void;
    /**
     * 构建增量特性编译链接完整命令
     *
     * @protected
     */
    protected buildIncrementalCompileLinkFullCommand(): void;
    /**
     ...
     * @protected
     */
    protected retainDeviceType(targetData: ModuleTargetData, entryName: string, _log: OhosLogger): void;
    /**
