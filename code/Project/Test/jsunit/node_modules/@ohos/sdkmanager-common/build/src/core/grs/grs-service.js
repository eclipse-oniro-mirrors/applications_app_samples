...
class GrsService {
    constructor(netClient) {
        this.getGrs0 = (param) => __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield this._netClient.doGet(`${param.url}?issue_country=${(0, utils_1.isEmpty)(param.issueCountry) ? 'CN' : param.issueCountry}`, new simple_progress_1.SimpleProgress());
        ...
        this.getGrs = () => __awaiter(this, void 0, void 0, function* () {
            const _param = this.getGrsParam();
            if (_param === null || _param === void 0 ? void 0 : _param.url) {
                yield this.getGrs0(_param);
            }
            else {
                for (const grsUrl of component_contants_1.defaultGrsUrls) {
                    const host = yield this.getGrs0({ url: grsUrl, issueCountry: _param === null || _param === void 0 ? void 0 : _param.issueCountry });
                    if (host) {
                        return;
                    }
                }
