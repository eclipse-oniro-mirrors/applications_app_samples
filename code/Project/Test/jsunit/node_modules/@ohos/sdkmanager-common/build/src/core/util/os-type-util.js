...
const getOsArchFromCommand = () => {
    var _a;
    const spawnSyncReturns = (0, child_process_1.spawnSync)('uname', ['-m'], { encoding: 'utf-8', shell: true });
...
const getOsArchFromMac = () => {
    for (const cpuInfo of node_os_1.default.cpus()) {
...
const getOsArch = (progress) => {
    ...
    if (isIntel64(osArch)) {
        ...
        progress === null || progress === void 0 ? void 0 : progress.warn(`CPU Architecture: ${osArch}`);
        return CPUArch.X64;
    }
};
