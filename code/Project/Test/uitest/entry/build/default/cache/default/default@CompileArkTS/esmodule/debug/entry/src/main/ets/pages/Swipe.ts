...
class Swipe extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        super(parent, __localStorage, elmtId, extraInfo);
        if (typeof paramsLambda === "function") {
            this.paramsGenerator_ = paramsLambda;
        }
        this.__message = new ObservedPropertySimplePU('Hello World Swipe', this, "message");
    ...
    setInitiallyProvidedValue(params: Swipe_Params) {
    ...
    updateStateVars(params: Swipe_Params) {
    }
...
registerNamedRoute(() => new Swipe(undefined, {}), "", { bundleName: "com.samples.test.uitest", moduleName: "entry", pagePath: "pages/Swipe", pageFullPath: "entry/src/main/ets/pages/Swipe", integratedHsp: "false", moduleType: "followWithHap" });
