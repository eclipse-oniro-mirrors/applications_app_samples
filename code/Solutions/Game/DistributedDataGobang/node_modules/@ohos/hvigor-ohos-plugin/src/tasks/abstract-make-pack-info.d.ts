...
export declare abstract class AbstractMakePackInfo extends OhosHapTask {
     ...
     */
    protected abstract getPackageObj(targetData: ModuleTargetData, moduleOptObj: ConfigOptObj | ModuleOptObj, noSuffixHapName: string): object;
    /**
     ...
     * 判断是否存在相关联的entry模块
     *
     * @param entryModules 待判断的entry模块数组
     */
    private noRelatedEntryModules;
    /**
