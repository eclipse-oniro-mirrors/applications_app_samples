...
2.本示例已适配API11版本SDK，SDK版本号(API Version 11 Release),镜像版本号(4.1.0 Release)。

3.本示例需要使用DevEco Studio NEXT Developer Preview2(Build Version: 4.1.3.700, built on March 19, 2024)版本才可编译运行。
