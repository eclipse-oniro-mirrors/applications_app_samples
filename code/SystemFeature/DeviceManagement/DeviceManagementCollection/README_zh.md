...
[ohos.permission.MANAGE_SECURE_SETTINGS](https://gitee.com/openharmony/docs/blob/master/zh-cn/application-dev/security/AccessToken/permissions-for-system-apps.md#ohos.permission.MANAGE_SECURE_SETTINGS)
