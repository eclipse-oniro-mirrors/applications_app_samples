...
public:
    ~PluginManager();
    static PluginRender *GetPlaginRender(int64_t &id);
    static napi_value DrawTransparentBuffer(napi_env env, napi_callback_info info);
    static napi_value SetSurfaceId(napi_env env, napi_callback_info info);
    static napi_value SetSurfaceId1(napi_env env, napi_callback_info info);
    static napi_value ChangeSurface(napi_env env, napi_callback_info info);
    static napi_value DestorySurface(napi_env env, napi_callback_info info);
