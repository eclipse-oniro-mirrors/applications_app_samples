...
declare namespace displaySetting {
  ...
  function setSurfaceId(surfaceid: string, callback: AsyncCallback<boolean>): void;
  function setSurfaceId(surfaceid: string): Promise<boolean>;
  /* CEC待机消息 */
  function off(type: 'CecStandBy', callback?: Callback<void>): void;
  function on(type: 'CecStandBy', callback: Callback<void>): void;
  /* CEC切换源消息 */
  function off(type: 'CecSelectSource', callback?: Callback<SourceType>): void;
  function on(type: 'CecSelectSource', callback: Callback<SourceType>): void;
