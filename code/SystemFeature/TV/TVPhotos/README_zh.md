...
1. 在首页可以看到“照片”和“相册”两个菜单，默认焦点位于“相册”，支持左右切换。“照片”用于展示所有照片和视频，“相册”包含照片、录屏截屏、视频和最近删除。
2. 焦点位于照片区域时，按确定键可查看照片或视频；选中视频后可播放，再次操作可关闭播放界面。
3. 焦点位于相册菜单时，按确定键可进入对应相册，查看其中的照片和视频；选中视频后可播放，再次操作可关闭播放界面。
4. 在首页按菜单键可打开底部菜单，包含“分享”“删除”“选择”三个操作。选择“选择”可进入编辑页面勾选照片；选择“分享”可将图片和视频分享至其他设备；选择“删除”可删除已选中的照片。
