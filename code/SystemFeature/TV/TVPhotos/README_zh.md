...
1. 首页提供“照片”和“相册”两个菜单，默认焦点位于“相册”，支持左右切换。“照片”页面展示全部照片和视频，“相册”页面包含照片、录屏截屏、视频和最近删除等分类。
2. 焦点位于照片区域时，按确定键可进入预览；选中视频资源时可进入播放界面。
3. 焦点位于相册菜单时，按确定键可进入对应相册并浏览其中的照片和视频；选中视频资源时可进入播放界面。
4. 首页按菜单键可打开底部操作菜单，提供“分享”“删除”“选择”三项功能。选择“选择”可进入编辑页面勾选照片；选择“分享”可将图片和视频分享至其他设备；选择“删除”可删除已选中的照片。
